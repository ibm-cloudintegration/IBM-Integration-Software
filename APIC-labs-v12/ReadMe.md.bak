...
|-------------------------|------------------------------------------------------------------------------------------------------------|
| [Expose Kafka Topic as AsyncAPI](AsyncAPI/Readme.md)       | **Integration with AsyncAPI's Event Endpoint Experience**  Here you will explore the full potential of ASYNCAPI with IBM Event Endpoint Management (EEM), Confluent Kafka, and IBM API Connect. ASYNCAPI enables the integration of Kafka Topics into AsyncAPIs.
|-------------------------|------------------------------------------------------------------------------------------------------------|
